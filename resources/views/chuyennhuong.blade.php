...
=======
        ...
        <div class="col-3 sign">
          ...
          >
            <div class="d-sm-inline-block d-none">
              Xin chào ,
              <a href="" style="color: #ffb72d; text-decoration: none"
                >&nbsp; Bách Nguyễn</a
              >
            </div>
      ...
      <div class="text-center v-league">
        <p class="top-banner-text">
          Official V.league 1 Fantasy Football Application
        </p>
        <img src="./images/vleague1.png" alt="" class="fanta-mb" />
      </div>
      <div class="partner">
        <img src="/images/partner.png" style="float: left" />
        <p class="container" style="margin-left: 14%; font-size: 14px">
          ĐỐI TÁC VẬN HÀNH
        </p>
      </div>
      <div>
...
>>>>>>> ae8e8b510c5ec622505b9f1f61bcdff8e13be4dd
          ...
          <div class="modal-body">
            <div class="d-flex justify-content-end" id="exampleModalLabel">
              ...
              <div class="w-100" style="margin-left: 10%">
                ...
                <p style="font-size: 20px; font-weight: 600; margin-bottom: 0">
                  Andres Vieina
                </p>
                <p style="font-size: 12px; font-weight: 600; margin-bottom: 0">
                  CLB SHB Đà Nẵng
                </p>
                <p style="font-size: 12px; font-weight: 400; margin-bottom: 0">
                  vs HNFC (A)
          ...
          <div class="modal-footer">
            ...
            >
              ...
              <tbody>
                <tr
                  id="tab-1"
                  class="table-gr-background"
                  onclick="fun(this.id)"
                >
                  <th>18</th>
                  <th colspan="2" class="win-team text-end align-middle">
                    Nam Định
                  </th>
                  <th>
                    <div
                      class="rounded text-center"
                      style="background-color: #10003f; color: white"
                    >
                      1-0
                    </div>
                  </th>
                  <th colspan="2" class="lose-team text-start align-middle">
                    Sông Lam Nghệ An
                  </th>
                  <th>100</th>
                </tr>
                ...
                <tr class="info-tab-1" style="display: none">
                  <th colspan="5" class="tab-name">
                    Xuất hiện trong trận (số phút)
                  </th>
                ...
                >
                  <th>18</th>
                  <th colspan="2" class="lose-team text-end align-middle">
                    Nam Định
                  </th>
                  <th>
                    <div
                  ...
                  <th colspan="2" class="win-team text-start align-middle">
                    Hà Nội FC
                  </th>
                  <th>100</th>
                </tr>
...
=======
    <input
      class="form-group form-rounded vfatasy-menu"
      value="Bạn đang có 120tr và nhiệm vụ cần hoàn thành là chọn đủ 18 cầu thủ vào đội hình"
      type="text"
      readonly
    />
>>>>>>> ae8e8b510c5ec622505b9f1f61bcdff8e13be4dd
              ...
              <div class="">
                <div class="h-100 position-relative">
                  <div class="ads container d-flex justify-content-between">
                    <img
                      src="./images/ad_type1.png"
                      alt=""
                      class="d-inline-block"
                    />
                    <div
                      class="line-cf position-absolute"
                      style="margin-top: 2%; margin-left: 25%"
                    >
                      Tiền đạo
>>>>>>> ae8e8b510c5ec622505b9f1f61bcdff8e13be4dd
                    </div>
                  ...
                  <div class="row">
                    <div class="col-md-5 row col mx-auto">
                      <div class="col-md-4 col-20">
                        <img
                          src="images/anomus.png"
                          alt=""
                          class="field-img rounded-circle mx-auto d-block mb-1"
                        />
                        <button
                          class="select-player rounded-top w-100 mx-auto d-block lh-sm"
...
>>>>>>> ae8e8b510c5ec622505b9f1f61bcdff8e13be4dd
                      ...
                      <div class="col-md">
                        <img
                          ...
                          style="margin-left: 3.7%; margin-top: -0.2%"
                        />
                        <img
                          src="images/anomus.png"
                          alt=""
                        ...
                        />
                        <button
                          class="selected-player rounded-top w-100 mx-auto d-block lh-sm"
                        >
                          Chọn
                        </button>
                        <div class="field-info rounded-bottom">
            ...
            <div class="d-flex justify-content-center mt-4 pb-3">
              <button class="complete">Hoàn thành đội hình</button>
            </div>
          </div>
          <!-- start course 2 -->
          <div class="main-box w-100 pt-4 mt-4 d-md-block d-none">
            <table class="header-info mx-auto mb-4">
              <thead>
                <tr>
                  <th class="text-center" scope="col">
        ...
        <div class="col-md-3 mt-3">
          ...
          <select
            name=""
            id=""
            class="form-control form-select form-rounded mt-1"
            value=""
          >
            ...
            <ul class="navbar-nav">
              <li class="nav-item dropdown">
                <a
                  ...
                  style="padding: 0"
                >
                  Sắp xếp theo <strong>Tổng điểm</strong>
                </a>
                <ul
          ...
          <div
            class="form-control form-select form-rounded mt-1 mb-1"
            style="line-height: 32px"
          >
            <ul class="navbar-nav">
              <li class="nav-item dropdown">
