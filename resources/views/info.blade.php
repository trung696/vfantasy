    ...
    <div class="menu">
        ...
        <div class="partner">
          ...
          <div class="vfatasy" id="vfatasy">
            <img src="/images/vfantasy.png" class="d-none d-md-inline vfantasy-big"/>
      ...
      <div class=" d-flex vfatasy-menu pill">
            <div class="d-flex flex-grow-1 justify-content-center align-items-center">
                <p>Vui lòng cung cấp thông tin định danh để phục vụ quá trình trao thưởng!</p>
            </div>
    ...
    <div class="container d-flex justify-content-center ">
        <div class="login-form d-block">
            <div class="email-form">
                <div class="login-label mb-3">THÔNG TIN ĐỊNH DANH</div>
                <input type="email" class="form-control-lg rounded-pill w-100 ip-form" id="exampleFormControlInput1" placeholder="Họ và tên người chơi">
                <input type="email" class="form-control-lg rounded-pill w-100 ip-form" id="exampleFormControlInput1" placeholder="email@gmail.com">
                <input type="email" class="form-control-lg rounded-pill w-100 ip-form" id="exampleFormControlInput1" placeholder="Số điện thoại ">
            </div>
            <div class="email-form mt-3">
                <div class="login-label mb-3">Thông tin bổ sung</div>
                <input  class="form-control-lg rounded-pill w-100 ip-form" type="date" placeholder="Ngày sinh">
